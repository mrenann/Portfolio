...
internal val EnStrings = Strings(
    ...
    homeTab = HomeTabString(tabTitle = "About me", about = "\n" +
    ...
    contactTab = ContactTabString(tabTitle = "Contact me", title = "I'm available to discuss collaboration opportunities, exciting projects, or simply to exchange ideas. Looking forward to hearing from you!"),
