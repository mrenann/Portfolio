...
internal val PtStrings = Strings(
    ...
    homeTab = HomeTabString(tabTitle = "Sobre mim", about = "Desenvolvedor Android apaixonado por tecnologia. Com experiência na área, tenho focado em aprimorar minhas habilidades técnicas e colaborar em projetos diversos.\n" +
    ...
    contactTab = ContactTabString(tabTitle = "Contato", title = "Estou Disponível para Discutir Oportunidades de Colaboração, Projetos Empolgantes ou Simplesmente para Trocar Ideias. Aguardo o seu Contato!"),
