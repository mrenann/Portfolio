...
private val DarkColorScheme = darkColorScheme(
    ...
    primaryContainer = Color(0xFF07091C),
    onPrimaryContainer = Color.White,
    inversePrimary = Color(0xFF07091C),
    onSecondary = Color.White,
    secondaryContainer = Color(0xFF07091C),
    onSecondaryContainer = Color.White,
    onTertiary = Color.White,
    tertiaryContainer = Color(0xFF07091C),
    onTertiaryContainer = Color.White,
    surface = Color(0xFF07091C),
    onSurface = Color.White,
    surfaceVariant = Color(0xFF07091C),
    onSurfaceVariant = Color.White,
    surfaceTint = Color(0xFF07091C),
    inverseSurface = Color(0xFF07091C),
    inverseOnSurface = Color(0xFF07091C),
    error = Color(0xFF07091C),
    onError = Color(0xFF07091C),
    errorContainer = Color(0xFF07091C),
    onErrorContainer = Color(0xFF07091C),
    outline = Color(0xFF07091C),
    outlineVariant = Color(0xFF07091C),
    scrim = Color.Black,
    surfaceBright = Color(0xFF07091C),
