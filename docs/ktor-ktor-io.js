(function (root, factory) {
  ...
  var cancel$default_0 = kotlin_org_jetbrains_kotlinx_kotlinx_coroutines_core.$_$.o;
  var invokeOnCompletion$default = kotlin_org_jetbrains_kotlinx_kotlinx_coroutines_core.$_$.p;
  ...
  var toRawBits_0 = kotlin_kotlin.$_$.zl;
  ...
  var Companion_getInstance_0 = kotlin_kotlin.$_$.b6;
  ...
  var replace = kotlin_kotlin.$_$.ji;
  ...
  var IndexOutOfBoundsException_init_$Create$_0 = kotlin_kotlin.$_$.p2;
  ...
  function readBytesOf(_this__u8e3s4, min, max) {
    ...
    if (min === max ? min === 0 : false) {
      ...
      // Inline function 'kotlin.also' call
      var this_0 = new Int8Array(min);
      // Inline function 'kotlin.contracts.contract' call
      // Inline function 'io.ktor.utils.io.core.readBytesOf.<anonymous>' call
      readFully_3(_this__u8e3s4, this_0, 0, min);
      tmp = this_0;
    } else {
      ...
      $l$loop: while (size < max) {
        // Inline function 'kotlin.comparisons.minOf' call
        var b = array.length;
        var partSize = Math.min(max, b) - size | 0;
