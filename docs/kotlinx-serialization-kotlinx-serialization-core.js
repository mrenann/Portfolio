(function (root, factory) {
  ...
  var asList = kotlin_kotlin.$_$.l7;
  var objectCreate = kotlin_kotlin.$_$.af;
  var StringCompanionObject_getInstance = kotlin_kotlin.$_$.p5;
  ...
  var mapCapacity = kotlin_kotlin.$_$.ja;
  ...
  var KClass = kotlin_kotlin.$_$.lg;
  var Triple = kotlin_kotlin.$_$.ok;
  var Pair = kotlin_kotlin.$_$.ik;
  var LinkedHashMap = kotlin_kotlin.$_$.s6;
  var MutableMap = kotlin_kotlin.$_$.d7;
  var HashMap = kotlin_kotlin.$_$.o6;
  var LinkedHashSet = kotlin_kotlin.$_$.t6;
  var MutableSet = kotlin_kotlin.$_$.e7;
  var Set = kotlin_kotlin.$_$.g7;
  var HashSet = kotlin_kotlin.$_$.p6;
  ...
  var Duration__toIsoString_impl_9h6wsm = kotlin_kotlin.$_$.h3;
  var Duration = kotlin_kotlin.$_$.mj;
  var Companion_getInstance = kotlin_kotlin.$_$.u5;
  var toIntOrNull = kotlin_kotlin.$_$.zi;
  ...
  var countTrailingZeroBits = kotlin_kotlin.$_$.dl;
  var HashSet_init_$Create$_1 = kotlin_kotlin.$_$.v;
  var KTypeParameter = kotlin_kotlin.$_$.qg;
  var fillArrayVal = kotlin_kotlin.$_$.wd;
  var booleanArray = kotlin_kotlin.$_$.jd;
  var emptyMap = kotlin_kotlin.$_$.v8;
  var contentHashCode = kotlin_kotlin.$_$.c8;
  var Companion_getInstance_1 = kotlin_kotlin.$_$.v5;
  var isCharArray = kotlin_kotlin.$_$.ke;
  var charArray = kotlin_kotlin.$_$.md;
  var DoubleCompanionObject_getInstance = kotlin_kotlin.$_$.l5;
  var isDoubleArray = kotlin_kotlin.$_$.me;
  var FloatCompanionObject_getInstance = kotlin_kotlin.$_$.m5;
  var isFloatArray = kotlin_kotlin.$_$.ne;
  var isLongArray = kotlin_kotlin.$_$.qe;
  var Companion_getInstance_2 = kotlin_kotlin.$_$.a6;
  var _ULongArray___get_size__impl__ju6dtr = kotlin_kotlin.$_$.v4;
  var ULongArray = kotlin_kotlin.$_$.tk;
  var _ULongArray___init__impl__twm1l3 = kotlin_kotlin.$_$.r4;
  var _ULong___init__impl__c78o9k = kotlin_kotlin.$_$.n4;
  var ULongArray__get_impl_pr71q9 = kotlin_kotlin.$_$.t4;
  ...
  var Companion_getInstance_3 = kotlin_kotlin.$_$.z5;
  var _UIntArray___get_size__impl__r6l8ci = kotlin_kotlin.$_$.l4;
  var UIntArray = kotlin_kotlin.$_$.rk;
  var _UIntArray___init__impl__ghjpc6 = kotlin_kotlin.$_$.h4;
  var _UInt___init__impl__l7qpdl = kotlin_kotlin.$_$.e4;
  var UIntArray__get_impl_gp5kza = kotlin_kotlin.$_$.j4;
  var _UInt___get_data__impl__f0vqqw = kotlin_kotlin.$_$.f4;
  var ShortCompanionObject_getInstance = kotlin_kotlin.$_$.o5;
  var isShortArray = kotlin_kotlin.$_$.re;
  var Companion_getInstance_4 = kotlin_kotlin.$_$.b6;
  var _UShortArray___get_size__impl__jqto1b = kotlin_kotlin.$_$.f5;
  var UShortArray = kotlin_kotlin.$_$.vk;
  var _UShortArray___init__impl__9b26ef = kotlin_kotlin.$_$.b5;
  var _UShort___init__impl__jigrne = kotlin_kotlin.$_$.x4;
  var UShortArray__get_impl_fnbhmx = kotlin_kotlin.$_$.d5;
  var _UShort___get_data__impl__g0245 = kotlin_kotlin.$_$.y4;
  var ByteCompanionObject_getInstance = kotlin_kotlin.$_$.k5;
  var isByteArray = kotlin_kotlin.$_$.je;
  var Companion_getInstance_5 = kotlin_kotlin.$_$.y5;
  var _UByteArray___get_size__impl__h6pkdv = kotlin_kotlin.$_$.c4;
  var UByteArray = kotlin_kotlin.$_$.pk;
  var _UByteArray___init__impl__ip4y9n = kotlin_kotlin.$_$.z3;
  var _UByte___init__impl__g9hnc4 = kotlin_kotlin.$_$.v3;
  var UByteArray__get_impl_t5f3hv = kotlin_kotlin.$_$.a4;
  var _UByte___get_data__impl__jof9qr = kotlin_kotlin.$_$.w3;
  var BooleanCompanionObject_getInstance = kotlin_kotlin.$_$.j5;
  var isBooleanArray = kotlin_kotlin.$_$.ie;
  var coerceAtLeast = kotlin_kotlin.$_$.vf;
  var copyOf = kotlin_kotlin.$_$.l8;
  var copyOf_0 = kotlin_kotlin.$_$.n8;
  var copyOf_1 = kotlin_kotlin.$_$.o8;
  var copyOf_2 = kotlin_kotlin.$_$.j8;
  var _ULongArray___get_storage__impl__28e64j = kotlin_kotlin.$_$.w4;
  var _ULongArray___init__impl__twm1l3_0 = kotlin_kotlin.$_$.s4;
  var ULongArray__set_impl_z19mvh = kotlin_kotlin.$_$.u4;
  var copyOf_3 = kotlin_kotlin.$_$.q8;
  var _UIntArray___get_storage__impl__92a0v0 = kotlin_kotlin.$_$.m4;
  var _UIntArray___init__impl__ghjpc6_0 = kotlin_kotlin.$_$.i4;
  var UIntArray__set_impl_7f2zu2 = kotlin_kotlin.$_$.k4;
  var copyOf_4 = kotlin_kotlin.$_$.i8;
  var _UShortArray___get_storage__impl__t2jpv5 = kotlin_kotlin.$_$.g5;
  var _UShortArray___init__impl__9b26ef_0 = kotlin_kotlin.$_$.c5;
  var UShortArray__set_impl_6d8whp = kotlin_kotlin.$_$.e5;
  var copyOf_5 = kotlin_kotlin.$_$.m8;
  var _UByteArray___get_storage__impl__d4kctt = kotlin_kotlin.$_$.d4;
  var _UByteArray___init__impl__ip4y9n_0 = kotlin_kotlin.$_$.y3;
  var UByteArray__set_impl_jvcicn = kotlin_kotlin.$_$.b4;
  var copyOf_6 = kotlin_kotlin.$_$.k8;
  var Unit = kotlin_kotlin.$_$.xk;
  var trimIndent = kotlin_kotlin.$_$.jj;
  var equals_0 = kotlin_kotlin.$_$.mh;
  var charSequenceLength = kotlin_kotlin.$_$.od;
  var charSequenceGet = kotlin_kotlin.$_$.nd;
  var toString_0 = kotlin_kotlin.$_$.p3;
  var titlecase = kotlin_kotlin.$_$.vi;
  var isLowerCase = kotlin_kotlin.$_$.vh;
  var PrimitiveClasses_getInstance = kotlin_kotlin.$_$.s5;
  var ULong = kotlin_kotlin.$_$.uk;
  var UInt = kotlin_kotlin.$_$.sk;
  var UShort = kotlin_kotlin.$_$.wk;
  var UByte = kotlin_kotlin.$_$.qk;
  ...
  var get_indices_0 = kotlin_kotlin.$_$.q9;
  var Companion_getInstance_6 = kotlin_kotlin.$_$.x5;
  ...
  function PolymorphicSerializer$descriptor$delegate$lambda$lambda(this$0) {
    return function ($this$buildSerialDescriptor) {
      $this$buildSerialDescriptor.element$default_ey7ac9_k$('type', serializer_3(StringCompanionObject_getInstance()).get_descriptor_wjt6a0_k$());
  ...
  function CharArraySerializer_0() {
    ...
    PrimitiveArraySerializer.call(this, serializer_13(Companion_getInstance_1()));
  }
  ...
  function DoubleArraySerializer_0() {
    ...
    PrimitiveArraySerializer.call(this, serializer_14(DoubleCompanionObject_getInstance()));
  }
  ...
  function FloatArraySerializer_0() {
    ...
    PrimitiveArraySerializer.call(this, serializer_10(FloatCompanionObject_getInstance()));
  }
  ...
  function BooleanArraySerializer_0() {
    ...
    PrimitiveArraySerializer.call(this, serializer_4(BooleanCompanionObject_getInstance()));
  }
  ...
  function _init_properties_Primitives_kt__k0eto4() {
    if (!properties_initialized_Primitives_kt_6dpii6) {
      ...
      BUILTIN_SERIALIZERS = mapOf([to(PrimitiveClasses_getInstance().get_stringClass_bik2gy_k$(), serializer_3(StringCompanionObject_getInstance())), to(getKClass(Char), serializer_13(Companion_getInstance_1())), to(PrimitiveClasses_getInstance().get_charArrayClass_7lhfoe_k$(), CharArraySerializer()), to(PrimitiveClasses_getInstance().get_doubleClass_dahzcy_k$(), serializer_14(DoubleCompanionObject_getInstance())), to(PrimitiveClasses_getInstance().get_doubleArrayClass_84hee1_k$(), DoubleArraySerializer()), to(PrimitiveClasses_getInstance().get_floatClass_xlwq2t_k$(), serializer_10(FloatCompanionObject_getInstance())), to(PrimitiveClasses_getInstance().get_floatArrayClass_qngmha_k$(), FloatArraySerializer()), to(getKClass(Long), serializer_1(Companion_getInstance_0())), to(PrimitiveClasses_getInstance().get_longArrayClass_v379a4_k$(), LongArraySerializer()), to(getKClass(ULong), serializer_5(Companion_getInstance_2())), to(getKClass(ULongArray), ULongArraySerializer()), to(PrimitiveClasses_getInstance().get_intClass_mw4y9a_k$(), serializer_9(IntCompanionObject_getInstance())), to(PrimitiveClasses_getInstance().get_intArrayClass_h44pbv_k$(), IntArraySerializer()), to(getKClass(UInt), serializer_7(Companion_getInstance_3())), to(getKClass(UIntArray), UIntArraySerializer()), to(PrimitiveClasses_getInstance().get_shortClass_5ajsv9_k$(), serializer_8(ShortCompanionObject_getInstance())), to(PrimitiveClasses_getInstance().get_shortArrayClass_c1p7wy_k$(), ShortArraySerializer()), to(getKClass(UShort), serializer_12(Companion_getInstance_4())), to(getKClass(UShortArray), UShortArraySerializer()), to(PrimitiveClasses_getInstance().get_byteClass_pu7s61_k$(), serializer_6(ByteCompanionObject_getInstance())), to(PrimitiveClasses_getInstance().get_byteArrayClass_57my8g_k$(), ByteArraySerializer()), to(getKClass(UByte), serializer_11(Companion_getInstance_5())), to(getKClass(UByteArray), UByteArraySerializer()), to(PrimitiveClasses_getInstance().get_booleanClass_d285fr_k$(), serializer_4(BooleanCompanionObject_getInstance())), to(PrimitiveClasses_getInstance().get_booleanArrayClass_lnbwea_k$(), BooleanArraySerializer()), to(getKClass(Unit), serializer_2(Unit_getInstance())), to(PrimitiveClasses_getInstance().get_nothingClass_7ivpcc_k$(), NothingSerializer()), to(getKClass(Duration), serializer_0(Companion_getInstance()))]);
    }
  }
  ...
  function ULongSerializer() {
    ...
    this.descriptor_1 = InlinePrimitiveDescriptor('kotlin.ULong', serializer_1(Companion_getInstance_0()));
  }
  ...
  _.$_$.x1 = contextual;
  _.$_$.y1 = polymorphicDefault;
  _.$_$.z1 = SerializersModuleCollector;
