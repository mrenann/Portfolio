(function (root, factory) {
  ...
  setMetadataFor(Rect_0, 'Rect', classMeta);
  ...
  function toRect(_this__u8e3s4) {
    return new Rect_0(_this__u8e3s4.left_1, _this__u8e3s4.top_1, _this__u8e3s4.right_1, _this__u8e3s4.bottom_1);
  }
  ...
  function Rect(offset, size) {
    return new Rect_0(_Offset___get_x__impl__xvi35n(offset), _Offset___get_y__impl__8bzhra(offset), _Offset___get_x__impl__xvi35n(offset) + _Size___get_width__impl__58y75t(size), _Offset___get_y__impl__8bzhra(offset) + _Size___get_height__impl__a04p02(size));
  }
  function Companion_1() {
    Companion_instance_1 = this;
    this.Zero_1 = new Rect_0(0.0, 0.0, 0.0, 0.0);
  }
  ...
  function Rect_0(left, top, right, bottom) {
  ...
  protoOf(Rect_0).get_left_woprgw_k$ = function () {
    return this.left_1;
  };
  protoOf(Rect_0).get_top_18ivbo_k$ = function () {
    return this.top_1;
  };
  protoOf(Rect_0).get_right_ixz7xv_k$ = function () {
    return this.right_1;
  };
  protoOf(Rect_0).get_bottom_bj8ras_k$ = function () {
    return this.bottom_1;
  };
  protoOf(Rect_0).get_width_j0q4yl_k$ = function () {
    return this.right_1 - this.left_1;
  };
  protoOf(Rect_0).get_height_e7t92o_k$ = function () {
    return this.bottom_1 - this.top_1;
  };
  protoOf(Rect_0).get_size_cxx1ym_k$ = function () {
    return Size_0(this.get_width_j0q4yl_k$(), this.get_height_e7t92o_k$());
  };
  protoOf(Rect_0).get_isInfinite_uffwnt_k$ = function () {
  ...
  protoOf(Rect_0).get_isFinite_taph6q_k$ = function () {
    return ((isFinite(this.left_1) ? isFinite(this.top_1) : false) ? isFinite(this.right_1) : false) ? isFinite(this.bottom_1) : false;
  };
  protoOf(Rect_0).get_isEmpty_zauvru_k$ = function () {
    return this.left_1 >= this.right_1 ? true : this.top_1 >= this.bottom_1;
  };
  protoOf(Rect_0).translate_e972jg_k$ = function (offset) {
    return new Rect_0(this.left_1 + _Offset___get_x__impl__xvi35n(offset), this.top_1 + _Offset___get_y__impl__8bzhra(offset), this.right_1 + _Offset___get_x__impl__xvi35n(offset), this.bottom_1 + _Offset___get_y__impl__8bzhra(offset));
  };
  protoOf(Rect_0).translate_k2k08i_k$ = function (translateX, translateY) {
    return new Rect_0(this.left_1 + translateX, this.top_1 + translateY, this.right_1 + translateX, this.bottom_1 + translateY);
  };
  protoOf(Rect_0).inflate_rvluy7_k$ = function (delta) {
    return new Rect_0(this.left_1 - delta, this.top_1 - delta, this.right_1 + delta, this.bottom_1 + delta);
  };
  protoOf(Rect_0).deflate_e6rdlf_k$ = function (delta) {
    return this.inflate_rvluy7_k$(-delta);
  };
  protoOf(Rect_0).intersect_aqxwu2_k$ = function (other) {
    // Inline function 'kotlin.math.max' call
    var a = this.left_1;
    var b = other.left_1;
    ...
    return new Rect_0(tmp, tmp_0, tmp_1, tmp$ret$3);
  };
  protoOf(Rect_0).overlaps_l18ztf_k$ = function (other) {
  ...
  protoOf(Rect_0).get_minDimension_t9b43n_k$ = function () {
    // Inline function 'kotlin.math.min' call
  ...
  protoOf(Rect_0).get_maxDimension_xxccdn_k$ = function () {
    // Inline function 'kotlin.math.max' call
    // Inline function 'kotlin.math.absoluteValue' call
    var this_0 = this.get_width_j0q4yl_k$();
    var a = Math.abs(this_0);
  ...
  protoOf(Rect_0).component1_7eebsc_k$ = function () {
    return this.left_1;
  };
  protoOf(Rect_0).component2_7eebsb_k$ = function () {
    return this.top_1;
  };
  protoOf(Rect_0).component3_7eebsa_k$ = function () {
    return this.right_1;
  };
  protoOf(Rect_0).component4_7eebs9_k$ = function () {
    return this.bottom_1;
  };
  protoOf(Rect_0).copy_egrqb9_k$ = function (left, top, right, bottom) {
    return new Rect_0(left, top, right, bottom);
  };
  protoOf(Rect_0).copy$default_g2jcm4_k$ = function (left, top, right, bottom, $super) {
  ...
  protoOf(Rect_0).hashCode = function () {
  ...
  protoOf(Rect_0).equals = function (other) {
    if (this === other)
      return true;
    if (!(other instanceof Rect_0))
      return false;
    var tmp0_other_with_cast = other instanceof Rect_0 ? other : THROW_CCE();
  ...
  function toRect_0(_this__u8e3s4) {
    return Rect(Companion_getInstance_0().get_Zero_k6n73t_k$(), _this__u8e3s4);
  }
