(function (root, factory) {
  ...
  var get_lastIndex = kotlin_kotlin.$_$.zh;
  ...
  var MutableEntry = kotlin_kotlin.$_$.c7;
  ...
  var MutableIterator = kotlin_kotlin.$_$.z6;
  ...
  function decodeBase64Bytes_0(_this__u8e3s4) {
    ...
    $l$block: {
      ...
      try {
        ...
        while (_this__u8e3s4.get_remaining_mwegr1_k$().compareTo_9jj042_k$(new Long(0, 0)) > 0) {
          ...
          while (inductionVariable < last) {
            ...
            var other = _get_BASE64_MASK_$accessor$1rlrljx_e67tnp();
            accumulator = result | toByte(this_0 & other) << imul(3 - tmp1 | 0, 6);
          }
          ...
          if (last_0 <= inductionVariable_0)
            do {
              ...
              builder.writeByte_9ih3z3_k$(toByte(origin));
            }
  ...
  function fromBase64(_this__u8e3s4) {
    _init_properties_Base64_kt__ymmsz3();
    // Inline function 'kotlin.experimental.and' call
    var this_0 = toByte(_get_BASE64_INVERSE_ALPHABET_$accessor$1rlrljx_ynhlmj()[_this__u8e3s4 & 255]);
    var other = _get_BASE64_MASK_$accessor$1rlrljx_e67tnp();
    return toByte(this_0 & other);
  }
